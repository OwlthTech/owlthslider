...
{
    error_log("Data _POST on save: " . print_r($_POST, true));
    ...
    if (isset($_POST['os_slider_type'])) {
        ...
        if (term_exists($slider_type, 'os_slider_type')) {
            wp_set_object_terms($post_id, $slider_type, 'os_slider_type');
        }
    }

    // Save Slider Template
    if (isset($_POST['os_slider_template'])) {
        $slider_template = intval($_POST['os_slider_template']);
        if (term_exists($slider_template, 'os_slider_template')) {
            wp_set_object_terms($post_id, $slider_template, 'os_slider_template');
        }
    }
